...
@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/list-contact']/self::a[@class='small-box-footer']")private WebElement moreinfobutton;
...
@FindBy(xpath="//textarea[@placeholder='Enter the Address']")private WebElement enteraddress;
